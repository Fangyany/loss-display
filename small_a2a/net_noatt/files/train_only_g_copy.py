...
from net_only_g_copy import get_fake_traj_rel, get_pred_traj_rel, TrajectoryDiscriminator, Loss, get_model
...
def main():
    ...
    # ckpt_path_g = 'results_test_style00/lanegcn1/generator12.000.ckpt'
    # ckpt_path_d = 'results_test_style00/lanegcn1/discriminator12.000.ckpt'
    ...
    dataset = Dataset('../GraphGAN2/dataset/preprocess/train_crs_dist6_angle90.p', config, train=True)
